...
namespace DsrProject.Context.MigrationsPostgreSQL.Migrations
{
    ...
    [Migration("20230425011019_removed_respondent_model")]
    partial class removed_respondent_model
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("DsrProject.Context.Entities.Author", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            Name = "Ali",
                            Uid = new Guid("324b2e20-5174-4e82-b712-7cf4de9f27b7")
                        });
                });
            ...
            modelBuilder.Entity("DsrProject.Context.Entities.Thought", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Title = "Best",
                            Uid = new Guid("68cd6f73-8a9b-48e8-904b-f3e8edc40ad6")
                        },
                        new
                        {
                            Id = 2,
                            ...
                            Title = "Worst",
                            Uid = new Guid("eb228b59-e4dd-410e-ae63-f627ca2c5074")
                        });
                });
